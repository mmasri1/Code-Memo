...
1. **Linear Data Structures**
    1. [Arrays](dsa/arrays)
    2. [Strings](dsa/strings)
    3. [Linked list](dsa/linked-list)
    4. [Stack](dsa/stack)
    5. [Queues](dsa/queues)

2. **Trees**
    1. [Binary Trees](dsa/binary-trees)
    2. [Binary Search Trees (BST)](dsa/bst)
    3. [AVL Trees](dsa/avl-trees)
    4. [Trie](dsa/trie)
    5. [N-ary Trees](dsa/n-ary-trees)

3. **Hash Tables**
    1. [Hashmap](dsa/hashmap)
    2. [HashSet](dsa/hashset)

4. **Graphs**
    1. [Adjacency List](dsa/adjacency-list)
    2. [Adjacency Matrix](das/matrix)
...
1. [Contains Duplicate](leetcode/contains-duplicate)
2. [Contains Duplicate II](leetcode/contains-duplicate-ii)
3. [Two Sum](leetcode/two-sum)
4. [Two Sum II](leetcode/two-sum-ii)
5. Maximum Subarray ⏳
6. Best Time to Buy and Sell Stock ⏳
7. Product of Array Except Self ⏳
8. [Group Anagrams](leetcode/group-anagrams)
...
1. [Valid Palindrome](leetcode/valid-palindrome)
2. [Container With Most Water](leetcode/container-with-most-water)
3. [Longest Palindromic Substring](leetcode/longest-palindromic-substring)

#### Stack

1. [Valid Parentheses](leetcode/valid-parentheses)
2. [Daily Temperatures](leetcode/daily-temperatures)

#### Sliding Window

1. [Best Time to Buy and Sell Stock](leetcode/best-time-to-buy-and-sell-stock)
2. [Longest Substring Without Repeating Characters](leetcode/longest-substring-without-repeating-characters)

#### Linked Lists

1. [Reverse Linked List](leetcode/reverse-linked-list)
2. [Merge Two Sorted Lists](leetcode/merge-two-sorted-lists)
3. [Reorder List](leetcode/reorder-list)

#### Binary Search

1. [Binary Search](leetcode/binary-search)

### Trees

1. [Invert Binary Tree](leetcode/invert-binary-tree)
2. [Maximum Depth of Binary Tree](leetcode/maximum-depth-of-binary-tree)

### Tries

1. [Implement Trie (Prefix Tree)](leetcode/implement-trie-prefix-tree)
